import { Constants, Camera, FileSystem,Location, Permissions } from 'expo';
...
export default class CameraExample extends React.Component {
  ...
  renderBottomBar = () =>
    <View
      ...
      <View style={{ flex: 0.4 }}>
        ...
        >
          <Ionicons  name= "md-camera" style={{  color: 'white', fontSize : 70 }} > </Ionicons> 
        </TouchableOpacity>
      </View> 
  ...
  render() {
    // LOCATION 
    let text = 'Obteniendo coordenadas..';
    if (this.state.errorMessage) {
      text = this.state.errorMessage;
    } else if (this.state.location) {
      text = JSON.stringify(this.state.location);  // text con un JSON de las coordenadas 
    }
    // CAMERA
